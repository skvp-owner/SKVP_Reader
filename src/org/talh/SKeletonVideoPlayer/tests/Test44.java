...
public class Test44 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file42.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		try {
			if (! reader.getConnectionsColor().getDiffuseColor().equals(Color.web("#FF0000"))){
				return 37;
			}
			if (! reader.getConnectionsColor().getSpecularColor().equals(Color.web("#0000AA"))){
				return 38;
			}
		} catch (SKVPNonInitializedReaderException e) {
			return 39;
