...
public class Test26 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file24.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		if (! con.get(1).contains(2)) {
			return 38;
		}
		if (! con.get(2).contains(1)) {
			return 39;
		}
		if (con.get(3).size() != 0) {
			return 40;
