...
public class Test45 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file43.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		try {
			if (reader.getCameraLocation().getX() != 9){
				return 37;
			}
			if (reader.getCameraLocation().getY() != 4.5){
				return 38;
			}
