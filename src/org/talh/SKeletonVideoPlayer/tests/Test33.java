...
public class Test33 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file31.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		try {
			if (! reader.getJointColors()[1].getDiffuseColor().equals(Color.web("#726252"))) {
				return 37;
			}
			if (! reader.getJointColors()[2].getSpecularColor().equals(Color.web("#226352"))) {
				return 38;
			}
		} catch (SKVPNonInitializedReaderException e) {
			return 39;
