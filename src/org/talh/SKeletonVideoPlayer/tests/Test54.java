...
public class Test54 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file52.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		try {
			...
			System.out.println(cameraSceneRotation);
