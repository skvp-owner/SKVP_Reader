...
public class Test30 extends AbstractTest {

	protected int run() {
		ClassLoader cl = this.getClass().getClassLoader();
		URL resourceUrl = cl.getResource("org/talh/SKeletonVideoPlayer/tests/resources/file28.skvp");
		if (resourceUrl == null) {
			return 1;
		}
		...
		try {
			if (reader.getJointRadiuses()[1] != 8.0) {
				return 37;
			}
		} catch (SKVPNonInitializedReaderException e) {
			return 38;
